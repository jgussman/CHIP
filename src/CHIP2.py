...
class CHIP:
    ...
    def download_spectra(self):
        ''' Downloads all the spectra for each star in the NExSci, calculates the SNR and saves the 
        spectrum with the highest SNR for each star.
        ...
        for star_ID in hires_names_array:
            ...
            if obs_df.empty: 
                ...
                if best_SNR < 100: 
                    ...
                    logging.info(f"{star_ID}'s best SNR spectrum came from {best_SNR_filename} with an SNR={best_SNR}")
